...
urlpatterns = [
    ...
    path('selesai-materi/<int:materi_id>/', views.mark_materi_completed, name='mark_materi_completed'),
    ...
    path('guru/kuis/<int:kuis_id>/nilai/', views.lihat_nilai_kuis, name='lihat_nilai_kuis'),
    path('guru/kuis/<int:kuis_id>/toggle/', views.toggle_status_kuis, name='toggle_status_kuis'),
    # --- AUTHENTICATION ---
