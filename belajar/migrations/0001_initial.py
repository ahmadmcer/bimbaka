...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('materi', models.CharField(choices=[('materi_1', 'Materi 1: Perkalian dengan 0, 10, 100'), ('materi_2', 'Materi 2: Perkalian Bersusun'), ('materi_3', 'Materi 3: Perkalian Lanjutan'), ('materi_4', 'Materi 4: Pembagian Bersusun'), ('materi_5', 'Materi 5: Pembagian dengan Sisa'), ('materi_6', 'Materi 6: Operasi Campuran')], max_length=50, verbose_name='Materi')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('materi_soal', models.CharField(choices=[('materi_1', 'Materi 1: Perkalian dengan 0, 10, 100'), ('materi_2', 'Materi 2: Perkalian Bersusun'), ('materi_3', 'Materi 3: Perkalian Lanjutan'), ('materi_4', 'Materi 4: Pembagian Bersusun'), ('materi_5', 'Materi 5: Pembagian dengan Sisa'), ('materi_6', 'Materi 6: Operasi Campuran')], help_text='Materi asal dari soal ini', max_length=50, verbose_name='Materi Soal')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nilai_evaluasi_per_materi', to=settings.AUTH_USER_MODEL)),
            ],
            options={
